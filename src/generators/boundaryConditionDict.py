...
from src.models.settings import BCPatch, BoundaryConditions, InletValues, SnappyHexMeshSettings, TriSurfaceMeshGeometry
...
class BoundaryConditionDictGenerator:
    ...
    @staticmethod
    def update_boundary_conditions(boundary_conditions: BoundaryConditions, inletValues: InletValues):
        """
        ...
        """
        boundary_conditions.velocityInlet.u_value = inletValues.U
        boundary_conditions.velocityInlet.p_value = inletValues.p
        boundary_conditions.velocityInlet.k_value = inletValues.k
        boundary_conditions.velocityInlet.omega_value = inletValues.omega
        boundary_conditions.velocityInlet.epsilon_value = inletValues.epsilon
        boundary_conditions.velocityInlet.nut_value = inletValues.nut
    ...
    def write(mesh_settings: SnappyHexMeshSettings, boundary_conditions: BoundaryConditions, project_path: Union[str, Path]):
        ...
        Parameters:
        mesh_settings (dict): Dictionary specifying mesh settings.
        boundary_conditions (dict): Dictionary specifying boundary conditions for U, p, k, and omega.
        inletValues (dict): Dictionary specifying inlet values for U, p, k, and omega.
        """
